...
coverImage: "../../assets/growing/mushroom-grow-bag-guide.jpg"
coverAlt: "Mushroom grow bags shown at colonization, pinning, and fruiting stages"
...
faq:
  ...
  - question: "Can every filter grow bag go in a pressure sterilizer?"
    answer: "No. Confirm the bag film, filter, seal, fill mass, and supplier instructions are compatible with the exact heat-treatment process; unsuitable bags can deform, rupture, or lose filter integrity."
  - question: "Should I cut a grow bag before colonization is complete?"
    answer: "Usually no. Opening an incompletely colonized substrate increases exposure and can dry it. Follow the authenticated culture supplier's species-specific fruiting instructions."
targetSpecies: ["oyster mushrooms", "lion's mane"]
difficulty: moderate
methods: ["authenticated spawn", "documented clean workflow"]
substrates: ["hardwood sawdust", "straw"]
...
The [substrate guide](/growing/mushroom-substrate-guide/) explains material selection. Use an extension or authenticated culture supplier's complete formula rather than combining hydration and treatment numbers from unrelated recipes.
...
The [contamination guide](/growing/mushroom-contamination-guide/) organizes observations. Never smell closely, taste the substrate, scrape off visible mold, or assume white growth is always the intended fungus.
