---
title: "Mushroom Yield and Biological Efficiency: Calculate Comparable Batches"
description: "Calculate mushroom yield and biological efficiency with dry-substrate mass, harvest boundaries, flush records, quality grades, losses, and honest comparisons."
keywords: ["mushroom biological efficiency","calculate mushroom yield","mushroom batch records"]
category: growing
...
coverAlt: "Original editorial image illustrating mushroom yield and biological efficiency: calculate comparable batches"
...
relatedEntries: ["growing/mushroom-batch-records", "growing/mushroom-strain-trial-design", "growing/mushroom-substrate-hydration", "growing/store-homegrown-mushrooms"]
sources:
  - title: "Cornell harvest-to-market business planning"
    url: "https://smallfarms.cornell.edu/resources/harvest-to-market-guide/24199-2/"
  - title: "Cornell DIY substrate experiment"
    url: "https://smallfarms.cornell.edu/2025/04/the-science-of-diy-mushroom-substrates/"
  - title: "Penn State production and harvesting"
    url: "https://extension.psu.edu/forage-and-food-crops/mushrooms/production-and-harvesting"
faq:
  - question: "What is biological efficiency?"
    answer: "Fresh mushroom mass divided by dry substrate mass, multiplied by 100 percent."
  - question: "Why use dry substrate mass?"
    answer: "It removes added water from the denominator so hydrated batches can be compared more consistently."
  - question: "Do all flushes count?"
    answer: "Count the flush window defined before the comparison and report it explicitly."
  - question: "Should contaminated mushrooms count as yield?"
    answer: "Track gross growth and discarded or saleable mass separately; never market suspect product."
  - question: "Is higher BE always better?"
    answer: "No. Time, labor, energy, contamination, quality, and saleable yield also matter."
targetSpecies: ["cultivated saprotrophic mushrooms grown on defined substrates"]
difficulty: moderate
methods: ["dry-matter correction", "biological-efficiency calculation", "flush-level harvest accounting", "matched replicated batch comparison"]
substrates: ["hardwood sawdust blocks", "straw substrates", "defined supplemented substrates"]
conditions: { colonizationTemperature: "Use the authenticated culture supplier's range and record actual batch conditions; this calculation does not set a universal temperature.", fruitingTemperature: "Record crop-zone temperature by batch and compare only matched fruiting systems.", humidity: "Record sensor position and fruit-body condition; humidity is a context variable, not part of the BE formula.", light: "Keep the documented lighting schedule consistent across compared batches where relevant.", freshAir: "Record ventilation state and crop response; do not attribute a yield difference to one variable when airflow also changed." }
timeline: { colonization: "Record inoculation, colonization milestones, failures, and move to fruiting for every unit.", fruiting: "Record initiation, pins, every harvest, rehydration event, flush boundary, and room exit.", total: "Close the batch only after all units and harvested mass are reconciled with trim, rejects, samples, and saleable product." }
equipment: ["checked scale appropriate to ingredient and harvest masses", "tared food-contact containers", "dry-matter method or lot-specific supplier specification", "batch record with unit identifiers", "timer and consistent harvest procedure"]
contaminationRisks: [{ name: "Counting suspect product as saleable yield", prevention: "Separate gross growth, trim, quality rejects, contamination discard, samples, and saleable mass; never market suspect mushrooms." }, { name: "Comparing incompatible denominators", prevention: "Document dry matter, spawn convention, ingredients, units, and flush window before production." }, { name: "Selecting only successful bags", prevention: "Retain every started unit and failure in the batch history and state the population used for each summary." }]
steps: [{ title: "Define the comparison", instruction: "Write the species, strain, recipe, units, harvest standard, flush window, and primary outcome before production." }, { title: "Calculate dry substrate", instruction: "Correct every solid ingredient for moisture and state whether dry spawn solids are included." }, { title: "Record harvest components", instruction: "Weigh gross fruit bodies, trim, rejects, samples, and saleable mass separately using a consistent timing and tare." }, { title: "Calculate and contextualize BE", instruction: "Divide fresh harvest by dry substrate mass, multiply by 100, and retain unrounded inputs, failures, and per-unit results." }, { title: "Compare matched batches", instruction: "Interpret BE beside time, quality, contamination, labor, and room occupancy without changing the success rule after seeing results." }]
---

Biological efficiency (BE) is a production ratio, not a promise printed on a spawn label. It compares fresh mushrooms harvested with the dry mass of the substrate used to grow them. The calculation is simple; obtaining a denominator and numerator that mean the same thing across batches is the difficult part.

This guide builds a record that another grower can audit. It separates water from dry ingredients, gross growth from saleable product, flush totals from room occupancy, and biological performance from profit. Use the [batch-record guide](/growing/mushroom-batch-records/) alongside it when designing the actual worksheet.
...
When comparing recipes, randomize bag positions if practical and avoid putting every treatment on a single shelf. Position can confound temperature, airflow, humidity, light, and handling. The [strain-trial guide](/growing/mushroom-strain-trial-design/) provides a fuller matched-trial structure.

## Biological efficiency is not profitability

A higher BE can accompany weaker texture, oversized clusters, more trim, longer room use, or a less valuable grade. Track cap or tooth condition, cluster uniformity, shelf-life rejects, packaging loss, and actual saleable weight. The [postharvest storage guide](/growing/store-homegrown-mushrooms/) covers handling after a verified harvest.
...
2. [Cornell DIY substrate experiment](https://smallfarms.cornell.edu/2025/04/the-science-of-diy-mushroom-substrates/)
3. [Penn State production and harvesting](https://extension.psu.edu/forage-and-food-crops/mushrooms/production-and-harvesting)
