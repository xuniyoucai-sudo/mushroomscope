...
description: "Learn bolete identification with observable features, comparison points, field documentation tips, and conservative safety guidance."
keywords: ["bolete identification pores staining and lookalikes", "identification guide", "mushroom guide"]
...
# Bolete Identification: Pores, Staining, and Lookalikes

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** bolete identification pores staining and lookalikes
