---
title: "Bolete Identification: Pores, Staining, and Lookalikes"
seoTitle: "Bolete Identification: Pores & Staining Guide"
description: "Learn how to document a bolete's pores, flesh staining, stem, habitat, and lookalikes without treating any one feature as an edibility test."
keywords: ["bolete identification", "bolete pores", "blue staining bolete", "bolete lookalikes"]
...
sources:
  ...
  - title: "Michigan State University Extension — Michigan's Wild Harvested Mushrooms"
    url: "https://archive.lib.msu.edu/DMC/extension_publications/e2777/E2777-2002.PDF"
...
faq:
  - question: "Do pores instead of gills identify a bolete as edible?"
    answer: "No. A pore-bearing underside helps describe a specimen, but it does not identify a species or establish edibility. Keep the record unresolved until a qualified local expert can assess the complete specimen."
  - question: "Does blue staining mean a bolete is poisonous?"
    answer: "No single color-change reaction is a universal toxicity test. Record where and how quickly a change occurs, then use it with the full set of characters and a current regional key; do not use it to make an eating decision."
  - question: "What should I photograph on a suspected bolete?"
    answer: "Photograph the cap, pore surface, whole stem and base, a fresh cut showing any change over time, substrate, nearby trees, several ages, and a scale. Retain habitat and date notes with the images."
cap: { shape: ["convex to plane depending on age", "record margin and surface texture"], color: ["record in natural light", "note changes after handling or rain"], surface: ["dry, velvety, tacky, or cracked"], size: "Measure cap width and photograph the full cap." }
stem: { shape: ["central, equal, club-shaped, or bulbous"], color: ["record from top to base", "note reticulation, dots, or other markings"], surface: ["smooth, fibrous, reticulate, or scabrous"], ring: "Record any veil remnants without treating their absence as decisive.", volva: "Excavate carefully and record the complete base; do not assume a bulb is a volva." }
gills: { attachment: ["not applicable when a true pore surface is present"], spacing: ["describe pore size and density instead"], color: ["record young and mature pore color"], notes: "Confirm that the underside is made of tube openings rather than gills, folds, teeth, or a smooth surface." }
spores: { printColor: ["make and photograph a print only when safe and useful", "record the color against light and dark paper"], shape: ["microscopy may be required for a species determination"], size: "Do not infer microscopic traits from a photograph." }
habitat: { summary: "Record whether fruit bodies emerge from soil, wood, or buried material, plus nearby trees and the site conditions.", substrates: ["soil", "leaf litter", "wood-associated material"], associatedTrees: ["identify nearby potential hosts when possible"], regions: ["use a current regional flora or checklist"] }
safetyNotice: "A guide can help document a pore-bearing mushroom but cannot authenticate a wild specimen or its edibility. Do not eat a wild mushroom without qualified, local, in-person confirmation; seek urgent poison advice after a suspected ingestion."
---

## Start with the underside, then keep going

In field-guide use, a bolete is usually recognized by a cap-and-stem form with a spongy surface of tube openings (pores) under the cap rather than thin gills. That observation is useful, but it is only a starting category. The USDA Forest Service description of king bolete, for example, distinguishes its pore-filled tube layer from gills and also relies on pore color, a thick stem, and other traits. A photograph of brown cap plus pores cannot reliably name a species.

Treat this page as a documentation protocol, not a foraging rule. Bolete names, combinations of features, and possible species vary by region. Keep a specimen unidentified when habitat, pore surface, flesh reaction, stem details, or season does not fit a current local key.

## Confirm a pore surface

Turn the mushroom over before judging the cap. Photograph the underside in even light and look for a layer of many small openings leading into tubes. Record the following without converting them into a verdict:

- **Pore color and shape:** Note fresh and mature color, whether openings are round or angular, and whether they change where touched.
- **Tube layer:** Take a side view or a clean cross-section so the depth and attachment of the layer can be seen.
...
Use a repeatable record that another person can review. Montana State University recommends collecting the complete specimen and documenting features that might otherwise be missed. Where collection is legal, keep the stem base intact; photograph the mushroom in place first.

| Record | What to capture | Why it matters |
| --- | --- | --- |
| Habitat | Soil or wood association, nearby trees, site, date, and weather | Ecology can eliminate possibilities, but does not prove one. |
| Cap | Width, color in natural light, texture, cracks, margin, and age | Cap color alone is variable and easily misleading. |
| Pores and tubes | Close underside image, pore color, attachment, and a cross-section | This confirms the structure being described and preserves age-related changes. |
| Stem | Full length, base, surface pattern, and dimensions | Reticulation or dots may be useful only in a full regional comparison. |
| Cut and print | Timed images of a fresh cut; a spore print when safe and useful | Reactions and spore color add evidence, not a shortcut. |

The [mushroom photo checklist](/identification/mushroom-photo-checklist/) expands this into a reusable set of field images. If the underside is not genuinely pore-bearing, switch to the broader [mushroom identification guide](/identification/how-to-identify-mushrooms/) rather than forcing it into a bolete comparison.

## Use staining carefully

Pressing pores or cutting flesh can produce a reaction immediately, slowly, weakly, or not at all. Record the initial color, the location of contact, elapsed time, and light conditions. Avoid repeated bruising, which can make a subtle reaction look stronger or muddy the color.
...
Create a timed sequence rather than writing only “stains blue.” Photograph the untouched pore surface and flesh, the same area immediately after pressure or cutting, and the reaction again at a recorded interval. State whether color began in the pores, tube layer, cap flesh, or stem flesh. Note whether it spread, darkened, faded, or remained local. Keep the lighting and camera angle as consistent as practical. The broader [bruising and color-change protocol](/identification/mushroom-bruising-reactions/) separates injury reactions from spores, exposed pigments, latex, age, and decay.
...
Never use pores, a blue reaction, a popular rule of thumb, an app score, or a social-media consensus as an edibility test. Poison Control advises that wild mushrooms should not be eaten unless identified by an expert; lookalikes can be convincing, and cooking does not make a poisonous mushroom safe.
