...
Learn the vocabulary for cap shapes and how age can change a cap from convex to flat, uplifted, or depressed. The central task is cap shape, margin, surface, and age. A defensible observation separates what was directly seen from what was inferred. Common names, image-search results, and app suggestions can generate hypotheses, but none establishes identity or edibility.
...
- **convex or bell-shaped profile:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **central depression or umbo:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **margin development:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **dry or viscid surface:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **measurements at several ages:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
