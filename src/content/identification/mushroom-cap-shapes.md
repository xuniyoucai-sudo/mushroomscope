...
revisionSummary: "Expanded the guide with precise cap-profile vocabulary, age sequences, measurement and photography methods, margin and surface characters, and interpretation limits."
draft: false
featured: false
...
faq:
  - question: "Can mushroom cap shapes: a practical identification guide confirm that a mushroom is edible?"
  ...
  - question: "Does one mushroom keep the same cap shape as it grows?"
    answer: "Often not. Many caps progress from rounded or convex to flat, depressed, uplifted, or irregular, so several developmental stages are more informative than one specimen."
  - question: "Is an umbo the same as a pointed cap?"
    answer: "No. An umbo is a localized central elevation on a broader cap profile. Record whether it is broad, low, sharply defined, or nipple-like instead of using pointed as a complete description."
...
Observe whether gills or folds run down the stem, but do not assume that every funnel-shaped fungus has the same fertile-surface structure. The [gill-types guide](/identification/mushroom-gill-types/) explains attachment terms that should be recorded separately.
...
Then connect that record to the rest of the mushroom: fertile-surface type and attachment, stem characters, complete base, flesh, spore deposit, substrate, associated trees, date, and region. The [stem-features guide](/identification/mushroom-stem-features/) and [general identification workflow](/identification/how-to-identify-mushrooms/) cover those next steps.
