...
Use a conservative checklist before handling, documenting, or discussing any wild mushroom, especially when edibility is being considered. The central task is decision limits and documentation. A defensible observation separates what was directly seen from what was inferred. Common names, image-search results, and app suggestions can generate hypotheses, but none establishes identity or edibility.
...
- **multiple independent characters:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **local range and season:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **complete specimen:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **qualified in-person confirmation:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **poison-center response plan:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
