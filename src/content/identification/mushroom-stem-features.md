...
faq:
  - question: "Can mushroom stem features: rings, volvas, texture, and base confirm that a mushroom is edible?"
...
The [photo checklist](/identification/mushroom-photo-checklist/) provides the views needed to share this evidence, while the [gill-types guide](/identification/mushroom-gill-types/) helps connect underside attachment to the stem. Keep separate collections separate; a cap from one and a base from another can create a fictional combination.
