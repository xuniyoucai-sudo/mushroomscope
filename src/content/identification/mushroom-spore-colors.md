---
title: "Mushroom Spore Print Colors and How to Record Them"
description: "Use a controlled spore deposit to distinguish broad color groups while recognizing that print color alone never identifies a species."
keywords: ["mushroom spore print colors and how to record them", "mushroom identification", "field guide"]
...
faq:
  - question: "Can mushroom spore print colors and how to record them confirm that a mushroom is edible?"
...
Use a controlled spore deposit to distinguish broad color groups while recognizing that print color alone never identifies a species. The central task is spore-print preparation and color. A defensible observation separates what was directly seen from what was inferred. Common names, image-search results, and app suggestions can generate hypotheses, but none establishes identity or edibility.
...
- **white and cream deposits:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **pink to salmon deposits:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **brown to rust deposits:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **purple-brown to black deposits:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
- **lighting and background controls:** Record the feature in plain language, add a measurement or photograph, and note variation among specimens.
