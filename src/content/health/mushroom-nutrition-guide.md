...
description: "Review mushroom nutrition, including nutrients, current research, evidence limits, possible side effects, and practical safety guidance."
keywords: ["mushroom nutrition calories protein fiber and vitamins", "health guide", "mushroom guide"]
category: health
...
# Mushroom Nutrition: Calories, Protein, Fiber, and Vitamins

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** mushroom nutrition calories protein fiber and vitamins
