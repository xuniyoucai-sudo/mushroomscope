---
title: "Vitamin D in Mushrooms: What the Evidence Shows"
description: "Some mushrooms contain vitamin D2, especially after ultraviolet exposure, but amounts vary and labels or laboratory data matter."
keywords: ["vitamin d in mushrooms: what the evidence shows", "mushroom nutrition", "evidence review"]
category: health
...
faq:
  - question: "Does vitamin d in mushrooms: what the evidence shows prove a medical benefit?"
...
evidenceSummary: "Evidence must be interpreted in the specific context of vitamin D2 variability and dietary planning; broad treatment claims are not supported by food composition or preliminary research alone."
medicalDisclaimer: "Educational information only. This page does not diagnose, treat, or replace individualized medical care."
---

## Key takeaways

Some mushrooms contain vitamin D2, especially after ultraviolet exposure, but amounts vary and labels or laboratory data matter. The useful question is not whether mushrooms are “healthy” in the abstract, but what material was studied, in whom, at what dose, against what comparison, and with which outcome. This page focuses on vitamin D2 variability and dietary planning.
