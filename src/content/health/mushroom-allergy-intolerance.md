...
description: "Review mushroom allergy and intolerance, including nutrients, current research, evidence limits, possible side effects, and practical safety guidance."
keywords: ["mushroom allergy and intolerance symptoms and safety", "health guide", "mushroom guide"]
category: health
...
# Mushroom Allergy and Intolerance: Symptoms and Safety

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** mushroom allergy and intolerance symptoms and safety
