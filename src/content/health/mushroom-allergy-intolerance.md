...
imageNote: "Original editorial illustration; visual context only and not medical diagnostic evidence."
sources:
  - title: "FDA — Food Allergies"
    url: "https://www.fda.gov/food/nutrition-food-labeling-and-critical-foods/food-allergies"
  - title: "FDA — What You Need to Know about Foodborne Illnesses"
    url: "https://www.fda.gov/food/consumers/what-you-need-know-about-foodborne-illnesses"
  - title: "Ali and Smith — Agaricus bisporus mushroom anaphylaxis: A case report and review of the literature"
    url: "https://pubmed.ncbi.nlm.nih.gov/39282616/"
  - title: "Del Santo et al. — Occupational allergic IgE-mediated disease from Boletus edulis: case report"
    url: "https://pubmed.ncbi.nlm.nih.gov/16983976/"
  - title: "Poison Control — Food poisoning: Symptoms, treatment, and causes"
    url: "https://www.poison.org/articles/food-poisoning"
faq:
  - question: "Can I tell from symptoms alone whether mushrooms caused an allergy?"
    answer: "No. Skin, gastrointestinal, breathing, and dizziness symptoms can have multiple causes, including food allergy and foodborne illness. A clinician needs the timing, food and ingredient details, medical history, and appropriate testing to determine the cause."
  - question: "Are mushroom allergies common enough to assume every reaction is an allergy?"
    answer: "No. Published mushroom-allergy literature includes individual case reports and limited case series, which document that reactions can occur but do not diagnose a person or establish the likelihood after a particular meal."
  - question: "When is a reaction after eating mushrooms an emergency?"
    answer: "Trouble breathing, throat or tongue swelling, fainting, loss of consciousness, or rapidly worsening symptoms require emergency help. Stop eating the food and follow an emergency plan already prescribed by a clinician; do not try to test the food again at home."
  - question: "Does an occupational reaction mean I will react when eating mushrooms?"
    answer: "Not necessarily. Occupational exposure and ingestion are different routes, and individual case reports cannot predict another person’s response. Recurrent work-related respiratory or skin symptoms need occupational-health or clinical assessment."
evidenceSummary: "Individual mushroom-triggered allergic reactions and occupational sensitization are documented in case reports, but their frequency, triggers, and cross-reactivity cannot be inferred for an individual. Symptoms after mushrooms also may reflect foodborne illness or toxic exposure, so diagnosis requires clinical assessment."
medicalDisclaimer: "Educational information only. This page does not diagnose allergy, intolerance, poisoning, or foodborne illness, and it does not replace emergency or individualized medical care."
---
...
For product-selection context, see the [mushroom supplements guide](/health/mushroom-supplements-guide/). To distinguish the fungal material named on a label, see [fruiting body versus mycelium](/health/fruiting-body-vs-mycelium/). Neither page substitutes for an allergy or poisoning assessment.
...
1. [FDA — Food Allergies](https://www.fda.gov/food/nutrition-food-labeling-and-critical-foods/food-allergies)
2. [FDA — What You Need to Know about Foodborne Illnesses](https://www.fda.gov/food/consumers/what-you-need-know-about-foodborne-illnesses)
