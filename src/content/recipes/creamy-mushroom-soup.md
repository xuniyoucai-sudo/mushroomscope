---
title: "Creamy Mushroom Soup from Scratch"
description: "Make creamy mushroom soup from scratch with cultivated cremini mushrooms, clear steps, practical substitutions, and conservative food-safety guidance."
keywords: ["creamy mushroom soup from scratch", "mushroom recipe", "cremini mushrooms"]
category: recipes
...
faq:
  - question: "Which mushrooms work best for creamy mushroom soup from scratch?"
...
recipe:
  ...
  ingredients: ["450 g cremini mushrooms, sliced", "750 ml vegetable stock", "120 ml cream", "1 teaspoon thyme leaves", "1 small onion, chopped", "1 tablespoon olive oil", "salt and black pepper to taste"]
  instructions: ["Buy identified cultivated mushrooms from a reputable food supplier and discard spoiled pieces.", "Clean mushrooms with a soft brush or brief rinse, dry well, and cut into even pieces.", "Brown mushrooms, simmer with stock, blend part of the soup, and finish with cream.", "Season to taste and serve while hot.", "Cool leftovers promptly in a shallow covered container and refrigerate."]
---

## Why this recipe works

Make creamy mushroom soup from scratch with cultivated cremini mushrooms, clear steps, practical substitutions, and conservative food-safety guidance. Browning drives off surface moisture and builds savory flavor. Crowding a small pan traps steam, so cook in batches when necessary. The recipe uses vegetable stock, cream, and thyme to support rather than hide the mushroom flavor.
...
- **vegetable stock:** Provides the main cooking medium or structure. Use a suitable dietary substitute when needed.
- **cream:** Add after the mushrooms have begun to brown so it does not scorch.
- **thyme:** Adjust the amount to balance richness, acidity, or texture.
...
4. Brown mushrooms, simmer with stock, blend part of the soup, and finish with cream.
