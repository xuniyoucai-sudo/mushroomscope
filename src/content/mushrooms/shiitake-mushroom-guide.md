---
title: "Shiitake Mushrooms: Identification, Nutrition, and Uses"
description: "Explore shiitake mushrooms, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["shiitake mushrooms identification nutrition and uses", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Shiitake Mushrooms: Identification, Nutrition, and Uses

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** shiitake mushrooms identification nutrition and uses
