---
title: "Wood Ear Mushrooms: Identification and Culinary Uses"
description: "Explore wood ear mushrooms, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["wood ear mushrooms identification and culinary uses", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Wood Ear Mushrooms: Identification and Culinary Uses

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** wood ear mushrooms identification and culinary uses
