...
taxonomy:
  ...
  genus: Agaricus
identification:
  summary: "A cultivated specimen normally has a smooth white or brown cap, crowded gills that progress from pink through brown to dark chocolate, a central stem with a ring, and a brown spore print. The gills are free from the stem. Mature portobellos are broad and open, while buttons can be nearly spherical. Color alone is not diagnostic, because cultivated strains differ and wild Agaricus species overlap strongly in appearance."
  keyFeatures: ["Rounded and closed when young, expanding from white or brown into a broad brown cap at portobello maturity.","Free, crowded gills change from pink to chocolate brown as spores mature.","Central, firm, white to brownish, with a membranous ring and no volva.","Dark chocolate brown."]
appearance:
  cap: "Rounded and closed when young, expanding from white or brown into a broad brown cap at portobello maturity."
  hymenium: "Free, crowded gills change from pink to chocolate brown as spores mature."
  stem: "Central, firm, white to brownish, with a membranous ring and no volva."
  flesh: "White and firm, sometimes bruising pale pink or brown; mild mushroom aroma."
  sporePrint: "Dark chocolate brown."
habitat:
  summary: "A cultivated secondary decomposer associated with composted plant material and manure-rich substrates rather than living trees."
  regions: ["Cultivated worldwide","temperate grasslands and compost-rich sites"]
  substrates: ["conditioned mushroom compost","straw and manure compost","casing soil"]
season:
  summary: "Commercial crops are produced year-round; outdoor appearances are most frequent in mild, moist weather."
  months: ["January","February","March","April","May","June","July","August","September","October","November","December"]
edibility:
  status: edible
  notes: "Widely eaten cooked. Button, cremini, and portobello are market stages or color strains of the same species."
toxicity:
  level: none-known
  notes: "No inherent poisoning syndrome is recognized for normal food use, but allergy, spoilage, contamination, or mistaken wild identification remain possible."
nutrition:
  summary: "A low-energy food that supplies protein, fiber, riboflavin, niacin, pantothenic acid, selenium, copper, and potassium in amounts that vary by product and preparation."
growingDifficulty:
  level: expert
  notes: "Commercial production requires selective composting, pasteurization, spawning, casing, climate control, hygiene, and coordinated flush management."
similarSpecies:
  - name: "Agaricus campestris"
    differences: "A wild grassland species; identification requires more than its pink-to-brown gills."
  - name: "Agaricus xanthodermus"
    differences: "May yellow strongly at the stem base and can cause gastrointestinal poisoning; odor and bruising must be assessed by an expert."
...
- **Cap or upper surface:** Rounded and closed when young, expanding from white or brown into a broad brown cap at portobello maturity.
- **Fertile surface:** Free, crowded gills change from pink to chocolate brown as spores mature.
- **Stem or attachment:** Central, firm, white to brownish, with a membranous ring and no volva.
- **Flesh:** White and firm, sometimes bruising pale pink or brown; mild mushroom aroma.
...
No. A photograph can support documentation, but a defensible identification of Agaricus bisporus also considers substrate, location, developmental stage, underside, spore deposit, odor, texture, and sometimes microscopy or DNA. Never make an edibility decision from an image alone.

### Is it safe to eat?

white button mushroom is an established food when it comes from a reputable cultivated source and is stored and cooked properly. Individual allergy or intolerance is still possible. A wild specimen needs independent expert confirmation.

### Can beginners grow it?

The database rates cultivation as expert. Beginners should use authenticated spawn or a reputable ready-to-fruit block, follow the supplier's temperature and hygiene instructions, and discard cultures showing unexplained mold colors or foul odors.
