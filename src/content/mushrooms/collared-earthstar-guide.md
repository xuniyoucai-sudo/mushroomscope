---
title: "Collared Earthstar: Rays, Spore Sac, and Field Records"
seoTitle: "Collared Earthstar Identification and Field Records"
description: "Document Geastrum triplex by its split outer rays, central spore sac, collar, apical pore, woodland litter, maturity changes, and earthstar lookalikes."
...
sources:
  - title: "GBIF — Geastrum triplex"
    url: "https://www.gbif.org/species/2554367"
  - title: "NCBI Taxonomy Browser — Geastrum triplex"
    url: "https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?name=Geastrum+triplex"
  - title: "GBIF — Geastrum genus"
    url: "https://www.gbif.org/species/2525056"
  - title: "NAMA — Mushroom Poisoning Syndromes"
    url: "https://namyco.org/interests/toxicology/mushroom-poisoning-syndromes/"
faq:
  - question: "What makes an earthstar look like a star?"
    answer: "The outer wall of a closed fruit body splits into rays and bends outward, exposing a central spore sac that releases dry spores through an apical opening."
  - question: "What is the collar on Geastrum triplex?"
    answer: "The thick outer layer may split and leave a raised cup- or collar-like rim around the spore sac, but the feature varies with age and weathering."
  - question: "Does an earthstar have a conventional spore print?"
    answer: "No. Mature powdery spores leave through the pore when raindrops, debris, or pressure disturb the sac; microscopy samples that internal spore mass."
  - question: "Can every large collared earthstar be called Geastrum triplex?"
    answer: "No. Size, collar development, ray behavior, mouth structure, surface texture, substrate, microscopy, and region must be combined with a current key."
  - question: "Are collared earthstars edible?"
    answer: "This guide makes no food recommendation. Mature earthstars are tough and powdery, and web identification cannot establish species, condition, contamination, or safety."
scientificName: "Geastrum triplex"
commonNames: ["Collared earthstar", "Triple earthstar", "Saucered earthstar"]
externalIds: { gbif: "2554367" }
taxonomy: { kingdom: Fungi, phylum: Basidiomycota, class: Agaricomycetes, order: Geastrales, family: Geastraceae, genus: Geastrum }
identification:
  summary: "A relatively large woodland earthstar whose thick outer wall opens into several non-hygroscopic rays, often forming a collar around a sessile central spore sac with a defined apical pore."
  keyFeatures: ["Outer wall split into thick rays", "Raised collar around spore sac", "Round sessile spore sac", "Defined apical pore", "Leaf-litter woodland habitat"]
appearance:
  cap: "No conventional cap; the outer fruit-body wall splits into several thick star-like rays around a central sac."
  hymenium: "Spores mature internally as a dry gleba and escape through an apical pore rather than forming on exposed gills or pores."
  stem: "No ordinary stem; the central spore sac is generally sessile above the ray system."
  flesh: "Outer layers are thick and leathery when fresh, becoming papery or brittle; the mature interior becomes powdery spore mass."
  sporePrint: "Brown powder released from the apical opening rather than a conventional cap print."
habitat:
  summary: "A litter- and humus-associated saprotroph in deciduous, coniferous, and mixed woodland, parks, gardens, and other sites with accumulated organic material."
  regions: ["widespread records in temperate and subtropical regions", "local occurrence requires verification"]
  substrates: ["leaf litter", "humus-rich soil", "needle litter", "woodland mulch"]
season:
  summary: "Fresh fruit bodies often appear in late summer and autumn, while dry opened earthstars can persist for months and confuse observations of active season."
  months: ["August", "September", "October", "November"]
edibility:
  status: inedible
  notes: "Not recommended as food; mature texture is tough and powdery, and this page cannot establish an individual specimen's identity or condition."
toxicity:
  level: unknown
  notes: "No ingestion safety conclusion should be inferred from an earthstar shape or the absence of a widely reported poisoning syndrome."
nutrition:
  summary: "No meaningful culinary serving or verified nutrient profile is asserted."
growingDifficulty:
  level: expert
  notes: "Fruit-body production depends on authenticated culture and poorly standardized litter, soil, moisture, and seasonal variables."
similarSpecies:
  - name: "Geastrum saccatum"
    differences: "May lack the prominent broken collar and differs in details of the mouth, rays, sac surface, size, and regional ecology."
  - name: "Astraeus species"
    differences: "False earthstars often have strongly hygroscopic rays that close in dry conditions and differ microscopically and taxonomically."
  - name: "Myriostoma species"
    differences: "Saltshaker earthstars have multiple openings and a spore sac raised on several small columns rather than one apical pore on a sessile sac."
---
...
1. Photograph the patch and litter before moving anything.
2. Record closed, opening, mature, and old stages if naturally present.
3. Measure full diameter, sac diameter, ray number, and height.
4. Photograph the collar, sac surface, mouth, and low side profile.
5. Record substrate, trees, moisture, land use, and recent weather.
6. Sample mature spore mass only where collection is legal.
7. Compare microscopy and macroscopic features with a current regional key.

The [spore color guide](/identification/mushroom-spore-colors/) distinguishes the earthstar release system from a conventional cap print.
