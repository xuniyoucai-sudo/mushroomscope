...
faq:
  - question: "Can Parasol mushroom be identified from one photograph?"
...
commonNames: ["Parasol mushroom"]
externalIds: { gbif: "8914748" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Macrolepiota
identification:
  summary: "Very large umbrella-like cap with brown scales, free pale gills, and a tall snakeskin-patterned stem with a movable ring. Crowded white free gills. Tall hollow stem with brown zigzag pattern and a thick movable ring."
  keyFeatures: ["Very large umbrella-like cap with brown scales, free pale gills, and a tall snakeskin-patterned stem with a movable ring.", "Crowded white free gills.", "Tall hollow stem with brown zigzag pattern and a thick movable ring.", "White."]
appearance:
  cap: "Very large umbrella-like cap with brown scales, free pale gills, and a tall snakeskin-patterned stem with a movable ring."
  hymenium: "Crowded white free gills."
  stem: "Tall hollow stem with brown zigzag pattern and a thick movable ring."
  flesh: "White, soft in the cap and fibrous in the stem."
  sporePrint: "White."
habitat:
  summary: "A grassland and open woodland saprotroph."
  regions: ["Europe", "Asia", "Africa", "introduced elsewhere"]
  substrates: ["grassland soil", "woodland edges", "pasture"]
season:
...
similarSpecies:
  - name: "Chlorophyllum molybdites"
    differences: "poisonous, often green-spored, and common in warm lawns."
  - name: "Chlorophyllum rhacodes group"
    differences: "flesh stains and taxonomy differ."
---
...
A grassland and open woodland saprotroph. The documented range represented here includes Europe and Asia and Africa and introduced elsewhere. Typical substrates or settings include grassland soil and woodland edges and pasture. Fruiting records commonly occur in July, August, September, October, but latitude, elevation, rainfall, and host condition shift the calendar.
...
- **Chlorophyllum molybdites — poisonous, often green-spored, and common in warm lawns.**
- **Chlorophyllum rhacodes group — flesh stains and taxonomy differ.**
...
Parasol mushroom has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
