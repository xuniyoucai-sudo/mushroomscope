...
sources:
  - title: "GBIF — Agaricus arvensis"
    url: "https://www.gbif.org/species/5243403"
...
taxonomy:
  ...
  genus: Agaricus
identification:
  summary: "Large white caps that may yellow, free pink-to-brown gills, and a substantial double ring. Free gills mature from gray-pink to chocolate brown. Stout white stem with a skirt-like double ring and no volva."
  keyFeatures: ["Large white caps that may yellow, free pink-to-brown gills, and a substantial double ring.", "Free gills mature from gray-pink to chocolate brown.", "Stout white stem with a skirt-like double ring and no volva.", "Dark brown."]
appearance:
  cap: "Large white caps that may yellow, free pink-to-brown gills, and a substantial double ring."
  hymenium: "Free gills mature from gray-pink to chocolate brown."
  stem: "Stout white stem with a skirt-like double ring and no volva."
  flesh: "White, sometimes slowly yellowing, often with an anise-like odor."
  sporePrint: "Dark brown."
habitat:
  summary: "A grassland decomposer in meadows, verges, and nutrient-rich turf."
  regions: ["Europe", "Asia", "North America"]
  substrates: ["pasture", "road verges", "lawns"]
season:
...
similarSpecies:
  - name: "Agaricus xanthodermus"
    differences: "rapid chrome-yellow staining and phenolic odor indicate a toxic species group."
  - name: "Agaricus urinascens group"
