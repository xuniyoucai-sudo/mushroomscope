---
title: "Maitake Mushroom: Identification, Habitat, and Uses"
description: "Explore maitake mushroom, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["maitake mushroom identification habitat and uses", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Maitake Mushroom: Identification, Habitat, and Uses

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** maitake mushroom identification habitat and uses
