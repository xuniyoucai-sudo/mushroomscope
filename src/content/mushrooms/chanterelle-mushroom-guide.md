---
title: "Chanterelle Mushrooms: Identification and Lookalikes"
description: "Explore chanterelle mushrooms, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["chanterelle mushrooms identification and lookalikes", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Chanterelle Mushrooms: Identification and Lookalikes

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** chanterelle mushrooms identification and lookalikes
