...
taxonomy:
  ...
  genus: Suillus
identification:
  summary: "Brown very slimy caps, yellow pores, a pale ring, and association with two-needled pines. Yellow pore layer rather than gills; pores darken with age. Pale stem with glandular dots and a membranous ring."
  keyFeatures: ["Brown very slimy caps, yellow pores, a pale ring, and association with two-needled pines.", "Yellow pore layer rather than gills; pores darken with age.", "Pale stem with glandular dots and a membranous ring.", "Olive brown."]
appearance:
  cap: "Brown very slimy caps, yellow pores, a pale ring, and association with two-needled pines."
  hymenium: "Yellow pore layer rather than gills; pores darken with age."
  stem: "Pale stem with glandular dots and a membranous ring."
  flesh: "Pale yellow flesh that changes little when cut."
  sporePrint: "Olive brown."
habitat:
  summary: "A pine-associated mycorrhizal bolete, often introduced with plantations."
  regions: ["Europe", "Asia", "introduced worldwide"]
  substrates: ["soil beneath pines", "pine plantations"]
season:
...
similarSpecies:
  - name: "Suillus granulatus"
    differences: "lacks a ring and has glandular droplets when young."
  - name: "Suillus grevillei"
    differences: "associated with larch and usually more yellow-orange."
---
