---
title: "Craterellus cornucopioides: Black trumpet Species Guide"
seoTitle: "Black trumpet (Craterellus cornucopioides) Species Guide"
description: "Learn Black trumpet identification, habitat, season, lookalikes, safety, food context, and cultivation limits with current taxonomy and sources."
keywords: ["black trumpet", "Craterellus cornucopioides", "black trumpet identification"]
category: mushrooms
...
faq:
  - question: "Can Black trumpet be identified from one photograph?"
  ...
  - question: "Is wild Black trumpet safe to eat?"
...
commonNames: ["Black trumpet"]
externalIds: { gbif: "2554662" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Craterellus
identification:
  summary: "Dark gray to black, thin, hollow funnels with a wavy margin and no true gills. Smooth to faintly wrinkled outer fertile surface; the inner funnel is darker. Tapered hollow base continuous with the cap."
  keyFeatures: ["Dark gray to black, thin, hollow funnels with a wavy margin and no true gills.", "Smooth to faintly wrinkled outer fertile surface; the inner funnel is darker.", "Tapered hollow base continuous with the cap.", "White to pale cream."]
appearance:
  cap: "Dark gray to black, thin, hollow funnels with a wavy margin and no true gills."
  hymenium: "Smooth to faintly wrinkled outer fertile surface; the inner funnel is darker."
  stem: "Tapered hollow base continuous with the cap."
  flesh: "Thin, flexible, gray-black flesh with a strong aroma when dried."
  sporePrint: "White to pale cream."
habitat:
  summary: "Mycorrhizal on forest soil, often among leaf litter near hardwoods."
  regions: ["Europe", "temperate North America"]
  substrates: ["woodland soil", "leaf litter"]
season:
...
similarSpecies:
  - name: "Craterellus fallax"
    differences: "a closely related North American name requiring regional interpretation."
  - name: "Urnula craterium"
    differences: "a spring cup fungus with thicker, tougher flesh and a different structure."
---
...
1. Global Biodiversity Information Facility. [Craterellus cornucopioides species record](https://www.gbif.org/species/2554662). Taxonomic backbone and occurrence context.
