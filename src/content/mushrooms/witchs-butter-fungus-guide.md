---
title: "Witch's Butter Fungus: Yellow Jelly, Hosts, and Lookalikes"
seoTitle: "Witch's Butter Fungus Identification Guide"
description: "Document witch's butter by yellow gelatinous folds, wet-to-dry change, hardwood attachment, host-fungus ecology, microscopy, and jelly-fungus lookalikes."
...
sources:
  - title: "GBIF — Tremella mesenterica"
    url: "https://www.gbif.org/species/11945016"
  - title: "NCBI Taxonomy Browser — Tremella mesenterica"
    url: "https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?name=Tremella+mesenterica"
  - title: "GBIF — Peniophora genus"
    url: "https://www.gbif.org/species/2513703"
  - title: "NAMA — Mushroom Poisoning Syndromes"
    url: "https://namyco.org/interests/toxicology/mushroom-poisoning-syndromes/"
faq:
  - question: "Why does witch's butter appear after rain?"
    answer: "Its gelatinous tissue rehydrates and expands in wet weather, becoming conspicuous; in dry periods the same fruit body may shrink into a thin dark orange film."
  - question: "Does Tremella mesenterica decay wood by itself?"
    answer: "It is primarily parasitic on wood-decaying Peniophora fungi, so the branch supports a multi-organism interaction rather than a simple direct wood-decayer story."
  - question: "How can witch's butter be separated from Dacrymyces?"
    answer: "Host wood, fruit-body form, microscopic basidia and spores, and the presence of an associated crust fungus matter; yellow color alone cannot separate jelly fungi."
  - question: "Can a dried yellow smear rehydrate into witch's butter?"
    answer: "Some gelatinous fruit bodies shrink markedly and expand again with moisture, but a rehydration response is not unique enough to establish the species."
  - question: "Is witch's butter edible?"
    answer: "This guide makes no food recommendation. Identity, substrate contamination, freshness, close species, and personal reactions cannot be resolved from a web photograph."
scientificName: "Tremella mesenterica"
commonNames: ["Witch's butter", "Yellow brain fungus", "Golden jelly fungus"]
externalIds: { gbif: "11945016" }
taxonomy: { kingdom: Fungi, phylum: Basidiomycota, class: Tremellomycetes, order: Tremellales, family: Tremellaceae, genus: Tremella }
identification:
  summary: "A yellow to orange, translucent, gelatinous mass of irregular folded lobes on dead attached or fallen hardwood, commonly associated with a Peniophora crust-fungus host."
  keyFeatures: ["Yellow translucent gelatinous lobes", "Hardwood branch substrate", "Strong wet-to-dry size change", "Associated crust fungus may be present", "Microscopy needed for close jelly fungi"]
appearance:
  cap: "No conventional cap; fruit bodies form irregular folded, brainlike, leaflike, or cushion-shaped yellow lobes."
  hymenium: "Spore-bearing surfaces cover exposed gelatinous lobes rather than forming gills, teeth, or a discrete pore layer."
  stem: "Absent; lobes emerge directly from bark through cracks associated with the underlying fungal host."
  flesh: "Soft, elastic, watery and translucent when hydrated, shrinking and becoming tougher or film-like when dry."
  sporePrint: "White to pale, usually less practical than microscopy of basidia and spores for identification."
habitat:
  summary: "Occurs on dead portions of hardwood branches and logs where its wood-decaying fungal host is present, including attached dead branches and fallen debris."
  regions: ["widespread temperate records", "local occurrence requires verified regional data"]
  substrates: ["dead hardwood branch", "fallen hardwood twig", "bark colonized by Peniophora", "standing dead hardwood portion"]
season:
  summary: "Can be observed in multiple seasons after wet weather; hydrated visibility is more informative than a universal month range."
  months: ["January", "March", "October", "December"]
edibility:
  status: unknown
  notes: "No food recommendation is made; a yellow jelly form does not establish identity, substrate cleanliness, or individual safety."
toxicity:
  level: unknown
  notes: "Do not infer safety from folklore, small size, or the lack of a famous poisoning syndrome."
nutrition:
  summary: "No verified serving-based nutrient values are asserted for this field organism."
growingDifficulty:
  level: expert
  notes: "Its parasitic relationship with another fungus makes authenticated co-culture and fruiting substantially different from ordinary sawdust-block cultivation."
similarSpecies:
  - name: "Dacrymyces chrysospermus"
    differences: "Often forms orange-yellow gelatinous cushions on conifer wood and differs microscopically, especially in basidial form."
  - name: "Tremella aurantia"
    differences: "May be associated with Stereum rather than Peniophora; host-fungus evidence and microscopy are important."
  - name: "Naematelia aurantialba"
    differences: "A cultivated or collected yellow jelly taxon in some regions with different host relationships and species-level evidence requirements."
---
...
Wood ear and cloud ear fungi are brown to dark, ear- or cup-shaped gelatinous fruit bodies on wood. Their fertile surfaces, thickness, texture, and taxonomic placement differ. The [wood ear guide](/mushrooms/wood-ear-mushroom-guide/) addresses the market-name and species boundary separately.
...
The [habitat guide](/identification/mushroom-habitat-identification/) helps prevent a fungus-on-fungus interaction from being reduced to “yellow growth on a stick.”
