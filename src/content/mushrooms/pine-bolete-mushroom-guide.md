...
taxonomy:
  ...
  genus: Boletus
identification:
  summary: "Robust reddish-brown cap, white then yellow-olive pores, and a thick reticulate stem. Fine pores mature from white to yellow and olive, without gills. Bulbous pale to brownish stem with a raised net pattern."
  keyFeatures: ["Robust reddish-brown cap, white then yellow-olive pores, and a thick reticulate stem.", "Fine pores mature from white to yellow and olive, without gills.", "Bulbous pale to brownish stem with a raised net pattern.", "Olive brown."]
appearance:
  cap: "Robust reddish-brown cap, white then yellow-olive pores, and a thick reticulate stem."
  hymenium: "Fine pores mature from white to yellow and olive, without gills."
  stem: "Bulbous pale to brownish stem with a raised net pattern."
  flesh: "White firm flesh that generally does not blue strongly."
  sporePrint: "Olive brown."
habitat:
  summary: "A mycorrhizal bolete associated mainly with pine and other conifers."
  regions: ["Europe", "Asia"]
  substrates: ["conifer forest soil", "pine-associated soil"]
season:
...
similarSpecies:
  - name: "Boletus edulis"
    differences: "typically paler brown and associated with several hosts."
  - name: "Rubroboletus species"
    differences: "some poisonous boletes have red pores and blue staining."
---
...
Pine bolete has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
