---
title: "Tricholoma matsutake: Matsutake Species Guide"
seoTitle: "Matsutake (Tricholoma matsutake) Species Guide"
description: "Learn Matsutake identification, habitat, season, lookalikes, safety, food context, and cultivation limits with current taxonomy and sources."
keywords: ["matsutake", "Tricholoma matsutake", "matsutake identification"]
category: mushrooms
...
sources:
  - title: "GBIF — Tricholoma matsutake"
    url: "https://www.gbif.org/species/5241820"
...
faq:
  - question: "Can Matsutake be identified from one photograph?"
  ...
  - question: "Is wild Matsutake safe to eat?"
  ...
  - question: "Where does Matsutake grow?"
    answer: "A mycorrhizal forest species associated with pines and other hosts. Regional records and host associations should be checked before applying this summary to a local collection."
  - question: "What is the spore print of Matsutake?"
    answer: "The expected deposit is white., but print color overlaps among fungi and cannot confirm this species by itself."
  - question: "Can Matsutake be cultivated at home?"
...
commonNames: ["Matsutake"]
externalIds: { gbif: "5241820" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Tricholoma
identification:
  summary: "White firm mushrooms with brown fibrous scales, a partial veil, and a strong spicy-aromatic odor. White notched gills may spot brown with age. Solid white stem with a ring zone and brown fibers below."
  keyFeatures: ["White firm mushrooms with brown fibrous scales, a partial veil, and a strong spicy-aromatic odor.", "White notched gills may spot brown with age.", "Solid white stem with a ring zone and brown fibers below.", "White."]
appearance:
  cap: "White firm mushrooms with brown fibrous scales, a partial veil, and a strong spicy-aromatic odor."
  hymenium: "White notched gills may spot brown with age."
  stem: "Solid white stem with a ring zone and brown fibers below."
  flesh: "Dense white flesh with a distinctive but subjective aroma."
  sporePrint: "White."
habitat:
  summary: "A mycorrhizal forest species associated with pines and other hosts."
  regions: ["East Asia", "northern Europe"]
  substrates: ["sandy forest soil", "pine-associated soil"]
season:
...
similarSpecies:
  - name: "Tricholoma pardinum"
    differences: "a poisonous gray-scaled species."
  - name: "Amanita smithiana and related amanitas"
    differences: "dangerous white mushrooms with different base structures."
---

## Identification overview

White firm mushrooms with brown fibrous scales, a partial veil, and a strong spicy-aromatic odor. White notched gills may spot brown with age. Solid white stem with a ring zone and brown fibers below. Dense white flesh with a distinctive but subjective aroma. Observe several ages because rain, drying, insects, and decomposition can alter color and texture. Photograph the undisturbed growth, upper surface, fertile surface, complete attachment, and a lengthwise section. A white. spore deposit is supporting evidence, never a species verdict.
...
Matsutake has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
...
1. Global Biodiversity Information Facility. [Tricholoma matsutake species record](https://www.gbif.org/species/5241820). Taxonomic backbone and occurrence context.
