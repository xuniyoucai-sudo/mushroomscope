---
title: "Scarlet Elf Cup: Red Cups, Dead Wood, and Species Limits"
seoTitle: "Scarlet Elf Cup Identification and Species Limits"
description: "Document scarlet elf cups by red cup shape, pale outer surface, buried hardwood attachment, spring timing, microscopy limits, and regional Sarcoscypha species."
...
sources:
  - title: "GBIF — Sarcoscypha coccinea"
    url: "https://www.gbif.org/species/8156721"
  - title: "NCBI Taxonomy Browser — Sarcoscypha coccinea"
    url: "https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?name=Sarcoscypha+coccinea"
  - title: "GBIF — Sarcoscypha austriaca"
    url: "https://www.gbif.org/species/8689016"
  - title: "NAMA — Mushroom Poisoning Syndromes"
    url: "https://namyco.org/interests/toxicology/mushroom-poisoning-syndromes/"
faq:
  - question: "Is every red cup fungus Sarcoscypha coccinea?"
    answer: "No. Several Sarcoscypha species and unrelated cup fungi overlap in color and form; hairs, spores, host, region, season, and sometimes DNA separate them."
  - question: "Where does a scarlet elf cup attach?"
    answer: "The cup typically arises from decaying hardwood twigs or branches, sometimes buried under litter so deeply that it appears to fruit directly from soil."
  - question: "Why is the inside red but the outside pale?"
    answer: "The bright inner surface is the fertile hymenium, while the outer surface is usually paler and may carry hairs whose microscopic form can aid species comparison."
  - question: "Can scarlet elf cups be identified from cap shape alone?"
    answer: "No. Cup shape changes with age and weather, and close species may be nearly indistinguishable without microscopic examination of spores and outer hairs."
  - question: "Are scarlet elf cups edible?"
    answer: "This guide makes no food recommendation. Small cup fungi can be confused, polluted by their substrate, or poorly documented, and a photograph cannot establish safety."
scientificName: "Sarcoscypha coccinea"
commonNames: ["Scarlet elf cup", "Scarlet cup", "Scarlet cup fungus"]
externalIds: { gbif: "8156721" }
taxonomy: { kingdom: Fungi, phylum: Ascomycota, class: Pezizomycetes, order: Pezizales, family: Sarcoscyphaceae, genus: Sarcoscypha }
identification:
  summary: "A small stalkless or short-stalked cup fungus with a smooth scarlet fertile interior, paler outer surface, and attachment to decaying hardwood, often conspicuous in cool wet months."
  keyFeatures: ["Smooth scarlet inner cup", "Paler outer surface", "Hardwood twig attachment", "Cup opens and flattens with age", "Close species require microscopy"]
appearance:
  cap: "Cup- to saucer-shaped, often irregular with age, scarlet on the inner fertile surface and much paler outside."
  hymenium: "Smooth red inner surface that bears asci and releases microscopic spores rather than gills, teeth, or pores."
  stem: "Absent to short and narrowed, sometimes hidden in moss or litter where it attaches to decaying wood."
  flesh: "Thin, pale, and somewhat brittle or flexible depending on hydration, without the layered structure of a bracket fungus."
  sporePrint: "Usually not collected as a conventional cap print; microscopic ascospore examination uses discharged spores or prepared tissue."
habitat:
  summary: "A saprotrophic cup fungus on decaying hardwood sticks and branches in damp deciduous or mixed woodland, frequently partly buried by leaf litter."
  regions: ["Europe", "temperate occurrence regions represented by verified records"]
  substrates: ["decaying hardwood twig", "buried hardwood branch", "mossy hardwood debris", "leaf litter over wood"]
season:
  summary: "Often observed from winter into spring in mild temperate regions, with local moisture, snowmelt, altitude, and latitude shifting timing."
  months: ["January", "February", "March", "April"]
edibility:
  status: unknown
  notes: "No culinary recommendation is made; close-species resolution and specimen condition are not established by a web image."
toxicity:
  level: unknown
  notes: "Absence of a famous toxin is not evidence that an unidentified red cup, contaminated substrate, or individual serving is safe."
nutrition:
  summary: "No reliable serving-level nutrient values are asserted for this field species."
growingDifficulty:
  level: expert
  notes: "Culture and fruiting require authenticated material and controlled wood-decay conditions; it is not a standard home food crop."
similarSpecies:
  - name: "Sarcoscypha austriaca"
    differences: "Can be macroscopically very similar; spore characters and the form of hairs on the outer surface are important in regional separation."
  - name: "Sarcoscypha occidentalis"
    differences: "Often smaller and more distinctly stalked in its documented range, but geography and microscopy remain necessary."
  - name: "Aleuria aurantia"
    differences: "Orange peel fungus is generally orange, often ground-fruiting, and forms broader irregular cups without the same scarlet-inner and pale-outer combination."
---
...
A cup that seems to grow from soil may still originate from buried wood. Conversely, nearby wood is not proof of attachment. The [habitat guide](/identification/mushroom-habitat-identification/) provides a practical method for distinguishing visible substrate from an assumed host.
...
The [mushroom photo checklist](/identification/mushroom-photo-checklist/) helps ensure that a beautiful overhead frame is accompanied by useful side and substrate views.
