---
title: "Sparassis crispa: Cauliflower fungus Species Guide"
seoTitle: "Cauliflower fungus (Sparassis crispa) Species Guide"
description: "Learn Cauliflower fungus identification, habitat, season, lookalikes, safety, food context, and cultivation limits with current taxonomy and sources."
keywords: ["cauliflower fungus", "Sparassis crispa", "cauliflower fungus identification"]
category: mushrooms
...
faq:
  - question: "Can Cauliflower fungus be identified from one photograph?"
  ...
  - question: "Is wild Cauliflower fungus safe to eat?"
...
commonNames: ["Cauliflower fungus"]
externalIds: { gbif: "2550247" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Sparassis
identification:
  summary: "A large cream to ochre mass of flattened, tightly curled, leaf-like branches. The fertile surface covers both sides of the flattened lobes rather than forming gills. A short buried base branches repeatedly into the visible mass."
  keyFeatures: ["A large cream to ochre mass of flattened, tightly curled, leaf-like branches.", "The fertile surface covers both sides of the flattened lobes rather than forming gills.", "A short buried base branches repeatedly into the visible mass.", "White to pale cream."]
appearance:
  cap: "A large cream to ochre mass of flattened, tightly curled, leaf-like branches."
  hymenium: "The fertile surface covers both sides of the flattened lobes rather than forming gills."
  stem: "A short buried base branches repeatedly into the visible mass."
  flesh: "White to cream, brittle-tender when young and tougher with age."
  sporePrint: "White to pale cream."
habitat:
  summary: "A root and butt-associated fungus, especially near conifers."
  regions: ["Europe", "northern Asia"]
  substrates: ["conifer roots", "buried wood", "tree bases"]
season:
...
similarSpecies:
  - name: "Sparassis radicata"
    differences: "a western North American species with a deep rooting base."
  - name: "Sparassis spathulata"
    differences: "thinner, more zoned branches and a different range."
---
...
A root and butt-associated fungus, especially near conifers. The documented range represented here includes Europe and northern Asia. Typical substrates or settings include conifer roots and buried wood and tree bases. Fruiting records commonly occur in August, September, October, November, but latitude, elevation, rainfall, and host condition shift the calendar.
...
- **Sparassis radicata — a western North American species with a deep rooting base.**
- **Sparassis spathulata — thinner, more zoned branches and a different range.**
...
Cauliflower fungus has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
...
1. Global Biodiversity Information Facility. [Sparassis crispa species record](https://www.gbif.org/species/2550247). Taxonomic backbone and occurrence context.
