---
title: "Hedgehog Mushrooms: Identification, Habitat, and Uses"
description: "Explore hedgehog mushrooms, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["hedgehog mushrooms identification habitat and uses", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Hedgehog Mushrooms: Identification, Habitat, and Uses

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** hedgehog mushrooms identification habitat and uses
