---
title: "Inonotus obliquus: Chaga Species Guide"
seoTitle: "Chaga (Inonotus obliquus) Species Guide"
description: "Learn Chaga identification, habitat, season, lookalikes, safety, food context, and cultivation limits with current taxonomy and sources."
...
faq:
  - question: "Can Chaga be identified from one photograph?"
  ...
  - question: "Is wild Chaga safe to eat?"
  ...
  - question: "Where does Chaga grow?"
    answer: "A birch-associated pathogen of northern forests. Regional records and host associations should be checked before applying this summary to a local collection."
  - question: "What is the spore print of Chaga?"
    answer: "The expected deposit is yellowish when the rare fruit body sporulates., but print color overlaps among fungi and cannot confirm this species by itself."
  - question: "Can Chaga be cultivated at home?"
...
taxonomy:
  ...
  genus: Inonotus
identification:
  summary: "A sterile black cracked conk with a rusty-brown interior, usually on living birch; the true fruit body forms later under bark. The harvested conk has no visible gills or pores; it is not the sexual fruit body. No stem; the sterile mass erupts through bark."
  keyFeatures: ["A sterile black cracked conk with a rusty-brown interior, usually on living birch; the true fruit body forms later under bark.", "The harvested conk has no visible gills or pores; it is not the sexual fruit body.", "No stem; the sterile mass erupts through bark.", "Yellowish when the rare fruit body sporulates."]
appearance:
  cap: "A sterile black cracked conk with a rusty-brown interior, usually on living birch; the true fruit body forms later under bark."
  hymenium: "The harvested conk has no visible gills or pores; it is not the sexual fruit body."
  stem: "No stem; the sterile mass erupts through bark."
  flesh: "Hard black exterior with corky orange-brown internal tissue."
  sporePrint: "Yellowish when the rare fruit body sporulates."
habitat:
  summary: "A birch-associated pathogen of northern forests."
  regions: ["northern Europe", "northern Asia", "northern North America"]
  substrates: ["living birch", "occasionally other hardwoods"]
season:
...
similarSpecies:
  - name: "Tree burls"
    differences: "woody plant growth rather than fungal tissue."
  - name: "Other black cankers"
    differences: "require host, internal structure, and expert examination."
---

## Identification overview

A sterile black cracked conk with a rusty-brown interior, usually on living birch; the true fruit body forms later under bark. The harvested conk has no visible gills or pores; it is not the sexual fruit body. No stem; the sterile mass erupts through bark. Hard black exterior with corky orange-brown internal tissue. Observe several ages because rain, drying, insects, and decomposition can alter color and texture. Photograph the undisturbed growth, upper surface, fertile surface, complete attachment, and a lengthwise section. A yellowish when the rare fruit body sporulates. spore deposit is supporting evidence, never a species verdict.
