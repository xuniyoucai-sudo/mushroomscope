...
sources:
  - title: "GBIF — Lactarius deliciosus"
    url: "https://www.gbif.org/species/5248629"
...
faq:
  - question: "Can Saffron milk cap be identified from one photograph?"
  ...
  - question: "Is wild Saffron milk cap safe to eat?"
  ...
  - question: "Where does Saffron milk cap grow?"
    answer: "A pine-associated mycorrhizal mushroom on forest soil. Regional records and host associations should be checked before applying this summary to a local collection."
  - question: "What is the spore print of Saffron milk cap?"
    answer: "The expected deposit is pale cream, but print color overlaps among fungi and cannot confirm this species by itself."
  - question: "Can Saffron milk cap be cultivated at home?"
...
commonNames: ["Saffron milk cap"]
externalIds: { gbif: "5248629" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Lactarius
identification:
  summary: "Orange zoned caps and gills exude orange latex and often stain green with handling or age. Orange decurrent gills release colored latex when cut. Short orange stem with shallow darker pits."
  keyFeatures: ["Orange zoned caps and gills exude orange latex and often stain green with handling or age.", "Orange decurrent gills release colored latex when cut.", "Short orange stem with shallow darker pits.", "Pale cream."]
appearance:
  cap: "Orange zoned caps and gills exude orange latex and often stain green with handling or age."
  hymenium: "Orange decurrent gills release colored latex when cut."
  stem: "Short orange stem with shallow darker pits."
  flesh: "Brittle orange flesh producing carrot-orange latex."
  sporePrint: "Pale cream."
habitat:
  summary: "A pine-associated mycorrhizal mushroom on forest soil."
  regions: ["Europe", "introduced with pines elsewhere"]
  substrates: ["pine forest soil", "needle litter"]
season:
...
similarSpecies:
  - name: "Lactarius deterrimus"
    differences: "spruce-associated with different staining and ecology."
  - name: "Other orange milkcaps"
    differences: "latex color changes and host trees distinguish regional species."
---

## Identification overview

Orange zoned caps and gills exude orange latex and often stain green with handling or age. Orange decurrent gills release colored latex when cut. Short orange stem with shallow darker pits. Brittle orange flesh producing carrot-orange latex. Observe several ages because rain, drying, insects, and decomposition can alter color and texture. Photograph the undisturbed growth, upper surface, fertile surface, complete attachment, and a lengthwise section. A pale cream spore deposit is supporting evidence, never a species verdict.
...
Saffron milk cap has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
...
Saffron milk cap identification should start with the Lactarius pattern: brittle flesh, gills that exude colored latex when cut, and a mycorrhizal association with suitable host trees. For this species concept, orange zones on the cap, orange latex, green staining, and pine association are all important. Photograph the intact cap, decurrent gills, cut gill edge with fresh latex, stem pits if present, and nearby pine needles or host evidence. Latex color should be recorded immediately because it can change after exposure.

Orange milkcaps are a group, not a single risk-free visual category. Related Lactarius species may differ by host tree, staining behavior, taste, latex change, and regional taxonomy. Do not identify from cap color alone. Note whether the flesh is brittle rather than fibrous, whether the latex is carrot-orange, whether green staining appears on bruised areas, and whether the mushroom grows with pine rather than spruce or other hosts. Regional keys are especially useful because names applied in markets or older books may not match current taxonomy.

Food reputation should be tied to correct identity, freshness, and preparation. Older milkcaps can become brittle, dirty, insect-damaged, or strongly flavored. Some people react poorly to mushrooms that are widely eaten by others. Avoid tasting raw latex as an identification method; record color visually instead. Ecologically, saffron milk caps reflect a living tree partnership, so ordinary indoor block cultivation is not a beginner path. A strong published observation explains the host association, latex behavior, staining, and gill attachment together.
...
1. Global Biodiversity Information Facility. [Lactarius deliciosus species record](https://www.gbif.org/species/5248629). Taxonomic backbone and occurrence context.
