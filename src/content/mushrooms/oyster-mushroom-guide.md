...
faq:
  - question: "Can this mushroom be identified from a photograph?"
    answer: "No. A photograph can support documentation, but a defensible identification of Pleurotus ostreatus also considers substrate, location, developmental stage, underside, spore deposit, odor, texture, and sometimes microscopy or DNA. Never make an edibility decision from an image alone."
  - question: "Is it safe to eat?"
    answer: "oyster mushroom is an established food when it comes from a reputable cultivated source and is stored and cooked properly. Individual allergy or intolerance is still possible. A wild specimen needs independent expert confirmation."
  - question: "Can beginners grow it?"
    answer: "The database rates cultivation as easy. Beginners should use authenticated spawn or a reputable ready-to-fruit block, follow the supplier's temperature and hygiene instructions, and discard cultures showing unexplained mold colors or foul odors."
...
commonNames: ["oyster mushroom","pearl oyster mushroom","tree oyster"]
taxonomy:
  kingdom: Fungi
  ...
  genus: Pleurotus
identification:
  summary: "Look for laterally attached caps growing in shelves, pale gills that descend the attachment, white flesh, and a white to faintly lilac spore deposit. Cap color is variable and influenced by strain and temperature. A cluster may have almost no visible stems. Accurate field identification also records the wood, season, odor, texture, and nearby trees; photographs of the cap alone omit several decisive characters."
  keyFeatures: ["Fan-, shell-, or oyster-shaped; gray, gray-brown, or tan, often paler toward the margin.","White to cream gills run distinctly down the attachment or short stem.","Short, lateral, off-center, or absent; white and often hairy near the base.","White to pale lilac-gray."]
appearance:
  cap: "Fan-, shell-, or oyster-shaped; gray, gray-brown, or tan, often paler toward the margin."
  hymenium: "White to cream gills run distinctly down the attachment or short stem."
  stem: "Short, lateral, off-center, or absent; white and often hairy near the base."
  flesh: "White, firm when young, with a mild fungal aroma; tougher with age."
  sporePrint: "White to pale lilac-gray."
habitat:
  summary: "A wood-decaying fungus that fruits in overlapping shelves from dead or declining hardwood."
  regions: ["Europe","North America","temperate Asia","cultivated worldwide"]
  substrates: ["hardwood logs","pasteurized straw","supplemented hardwood sawdust"]
season:
  summary: "Wild fruiting is often associated with cool, wet periods, while controlled cultivation is possible throughout the year."
  months: ["September","October","November","December","January","February"]
edibility:
  status: edible
  notes: "A widely cultivated edible species, normally cooked before eating."
toxicity:
  level: none-known
  notes: "Cultivated oyster mushrooms are established foods, but spores can irritate sensitized workers and wild lookalikes require expert assessment."
nutrition:
  summary: "Provides protein, fiber, B vitamins, minerals, ergothioneine, and fungal beta-glucans; exact values vary with strain, substrate, freshness, and cooking."
growingDifficulty:
  level: easy
  notes: "One of the most accessible cultivated mushrooms when clean spawn, pasteurized substrate, humidity, light, and fresh air are managed."
similarSpecies:
  - name: "Pleurotus pulmonarius"
    differences: "A closely related pale oyster species; separation may require ecology, microscopy, or DNA."
  - name: "Pleurocybella porrigens"
    differences: "A thin white conifer-associated species; substrate and structure differ, and casual comparison is unsafe."
  - name: "Omphalotus species"
...
For food questions such as whether mushrooms provide fiber or protein, the [oyster mushroom nutrition guide](/health/oyster-mushroom-nutrition/) separates species, serving mass, water loss, added cooking ingredients, and food-versus-extract evidence. The broader [mushroom nutrition guide](/health/mushroom-nutrition-guide/) compares ordinary food portions across mushrooms. Nutrient values still vary by strain, substrate, water content, maturity, ultraviolet exposure, processing, and cooking. USDA FoodData Central is useful for representative values, but a database average is not a laboratory analysis of a particular package.
