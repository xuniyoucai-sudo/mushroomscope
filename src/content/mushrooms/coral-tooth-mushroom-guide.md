---
title: "Hericium coralloides: Coral tooth fungus Species Guide"
seoTitle: "Coral tooth fungus (Hericium coralloides) Species Guide"
description: "Learn Coral tooth fungus identification, habitat, season, lookalikes, safety, food context, and cultivation limits with current taxonomy and sources."
keywords: ["coral tooth fungus", "Hericium coralloides", "coral tooth fungus identification"]
category: mushrooms
...
sources:
  - title: "GBIF — Hericium coralloides"
    url: "https://www.gbif.org/species/5248532"
...
faq:
  - question: "Can Coral tooth fungus be identified from one photograph?"
  ...
  - question: "Is wild Coral tooth fungus safe to eat?"
  ...
  - question: "Where does Coral tooth fungus grow?"
    answer: "A hardwood decomposer, often on fallen beech, maple, or other broadleaf wood. Regional records and host associations should be checked before applying this summary to a local collection."
  - question: "What is the spore print of Coral tooth fungus?"
    answer: "The expected deposit is white., but print color overlaps among fungi and cannot confirm this species by itself."
  - question: "Can Coral tooth fungus be cultivated at home?"
...
commonNames: ["Coral tooth fungus"]
externalIds: { gbif: "5248532" }
taxonomy:
  kingdom: Fungi
  ...
  genus: Hericium
identification:
  summary: "A highly branched white coral-like fruit body with short hanging teeth along many branch surfaces. Numerous downward-pointing teeth carry the spores. No conventional stem; branches arise from a common attachment."
  keyFeatures: ["A highly branched white coral-like fruit body with short hanging teeth along many branch surfaces.", "Numerous downward-pointing teeth carry the spores.", "No conventional stem; branches arise from a common attachment.", "White."]
appearance:
  cap: "A highly branched white coral-like fruit body with short hanging teeth along many branch surfaces."
  hymenium: "Numerous downward-pointing teeth carry the spores."
  stem: "No conventional stem; branches arise from a common attachment."
  flesh: "White and tender when young, yellowing and toughening with age."
  sporePrint: "White."
habitat:
  summary: "A hardwood decomposer, often on fallen beech, maple, or other broadleaf wood."
  regions: ["Europe", "Asia", "North America"]
  substrates: ["fallen hardwood", "dead standing hardwood"]
season:
...
similarSpecies:
  - name: "Hericium americanum"
    differences: "longer teeth clustered at branch tips and a different regional concept."
  - name: "Hericium erinaceus"
    differences: "forms an unbranched cushion with long hanging teeth."
---

## Identification overview

A highly branched white coral-like fruit body with short hanging teeth along many branch surfaces. Numerous downward-pointing teeth carry the spores. No conventional stem; branches arise from a common attachment. White and tender when young, yellowing and toughening with age. Observe several ages because rain, drying, insects, and decomposition can alter color and texture. Photograph the undisturbed growth, upper surface, fertile surface, complete attachment, and a lengthwise section. A white. spore deposit is supporting evidence, never a species verdict.

## Habitat and season

A hardwood decomposer, often on fallen beech, maple, or other broadleaf wood. The documented range represented here includes Europe and Asia and North America. Typical substrates or settings include fallen hardwood and dead standing hardwood. Fruiting records commonly occur in August, September, October, November, but latitude, elevation, rainfall, and host condition shift the calendar.
...
- **Hericium americanum — longer teeth clustered at branch tips and a different regional concept.**
- **Hericium erinaceus — forms an unbranched cushion with long hanging teeth.**
...
Coral tooth fungus has a documented food-use context when the organism is correctly identified and the material is fresh, clean, and cooked. That reputation does not transfer to a wild specimen identified online. Individual allergy, gastrointestinal intolerance, spoilage, environmental contamination, and cross-contamination remain possible. Cooking does not make a poisonous species safe.
...
1. Global Biodiversity Information Facility. [Hericium coralloides species record](https://www.gbif.org/species/5248532). Taxonomic backbone and occurrence context.
