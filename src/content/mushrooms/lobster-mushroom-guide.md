---
title: "Lobster Mushrooms: Identification, Habitat, and Uses"
description: "Explore lobster mushrooms, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["lobster mushrooms identification habitat and uses", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Lobster Mushrooms: Identification, Habitat, and Uses

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** lobster mushrooms identification habitat and uses
