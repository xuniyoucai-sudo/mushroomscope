---
title: "Flammulina filiformis: Cultivated Enoki Mushroom Guide"
description: "Understand cultivated enoki taxonomy, identification, growing conditions, nutrition, Listeria food-safety precautions, lookalikes, and FAQs."
keywords: ["Flammulina filiformis","enoki","mushroom identification","mushroom growing guide"]
category: mushrooms
...
faq:
  ...
  - question: "Is it safe to eat?"
    answer: "enoki is an established food when it comes from a reputable cultivated source and is stored and cooked properly. Individual allergy or intolerance is still possible. A wild specimen needs independent expert confirmation."
...
taxonomy:
  ...
  genus: Flammulina
identification:
  summary: "Packaged cultivated enoki forms a dense cluster of narrow pale stems topped by tiny cream caps. Wild-type fruit bodies can be shorter, darker, and orange-brown, often with a velvety dark stem base. This contrast makes enoki a poor visual template for foraging. A white spore print, tissue characters, substrate, microscopy, and sometimes DNA are needed to distinguish Flammulina from dangerous brown-spored wood inhabitants."
  keyFeatures: ["In cultivation, tiny and white to cream; wild-type fruit bodies may have broader yellow-brown to orange-brown caps.","Pale, crowded gills attached to or slightly notched at the stem.","Very long, thin, and white in high-carbon-dioxide cultivation; darker and velvety toward the base in wild-type forms.","White."]
appearance:
  cap: "In cultivation, tiny and white to cream; wild-type fruit bodies may have broader yellow-brown to orange-brown caps."
  hymenium: "Pale, crowded gills attached to or slightly notched at the stem."
  stem: "Very long, thin, and white in high-carbon-dioxide cultivation; darker and velvety toward the base in wild-type forms."
  flesh: "Thin, pale, and elastic in cultivated clusters."
  sporePrint: "White."
habitat:
  summary: "A cold-tolerant wood decomposer; commercial enoki is produced in bottles or bags on sterilized formulated substrate."
  regions: ["East Asia","cultivated worldwide","Flammulina relatives occur broadly in temperate regions"]
  substrates: ["sterilized sawdust-based mixtures","hardwood and buried wood in nature"]
season:
  summary: "Indoor crops are year-round; wild-type Flammulina often fruits in cool weather."
  months: ["October","November","December","January","February","March"]
edibility:
  status: edible
  notes: "Commercial enoki is edible when handled hygienically and cooked thoroughly."
toxicity:
  level: low
  notes: "The mushroom itself is an established food, but enoki has been involved in serious Listeria outbreaks; raw consumption is not recommended."
nutrition:
  summary: "A low-energy food containing fiber, protein, B vitamins, minerals, ergothioneine, and fungal polysaccharides."
growingDifficulty:
  level: moderate
  notes: "Commercial form depends on sterile bottle culture plus deliberate control of light, carbon dioxide, temperature, and cluster shape."
similarSpecies:
  - name: "Flammulina velutipes"
    differences: "Historically used broadly for enoki; modern studies distinguish lineages, and market names may remain imprecise."
  - name: "Galerina marginata"
    differences: "A deadly poisonous wood-growing mushroom with rusty-brown spores; never use cultivated enoki appearance to assess a wild specimen."
  - name: "Other small wood-growing mushrooms"
    differences: "Many overlap in cap color and season and require full expert identification."
---

## Introduction

*Flammulina filiformis* is the species most commonly associated with the slender white clusters sold as enoki in East Asian cultivation. Older resources often use F. velutipes, and commercial labels may not reflect modern species boundaries. Cultivation creates an appearance dramatically different from wild-type Flammulina: low light and elevated carbon dioxide produce long white stems and very small caps.
...
- **Cap or upper surface:** In cultivation, tiny and white to cream; wild-type fruit bodies may have broader yellow-brown to orange-brown caps.
- **Fertile surface:** Pale, crowded gills attached to or slightly notched at the stem.
- **Stem or attachment:** Very long, thin, and white in high-carbon-dioxide cultivation; darker and velvety toward the base in wild-type forms.
- **Flesh:** Thin, pale, and elastic in cultivated clusters.
- **Spore print:** White.
...
- **Flammulina velutipes:** Historically used broadly for enoki; modern studies distinguish lineages, and market names may remain imprecise.
- **Galerina marginata:** A deadly poisonous wood-growing mushroom with rusty-brown spores; never use cultivated enoki appearance to assess a wild specimen.
- **Other small wood-growing mushrooms:** Many overlap in cap color and season and require full expert identification.
...
**Known range represented here:** East Asia, cultivated worldwide, Flammulina relatives occur broadly in temperate regions. **Typical substrates:** sterilized sawdust-based mixtures, hardwood and buried wood in nature. Indoor crops are year-round; wild-type Flammulina often fruits in cool weather.
...
Home production is possible with a verified kit, but reproducing uniform commercial clusters is demanding. Sterile substrate preparation, bottle geometry, cooling, humidity, light restriction, and carbon-dioxide control all influence form. Do not seal an improvised container without filtered gas exchange. Harvest cleanly and cool the crop promptly. If green, black, pink, or foul-smelling contamination appears, isolate and discard the block according to supplier advice.
...
2. **Match the substrate.** Use sterilized sawdust-based mixtures or hardwood and buried wood in nature only through a proven recipe. Moisture and heat treatment must suit the method.
...
Enoki contributes texture, fiber, and micronutrients to meals. Cell, animal, and extract studies investigate polysaccharides and other compounds, but they do not show that cooked enoki prevents tumors or treats chronic disease in people. Food safety is the better-established health issue. Nutritional benefits cannot compensate for contamination, and washing alone is not a validated substitute for thorough cooking.
...
Public-health agencies have investigated multistate Listeria outbreaks linked to enoki mushrooms. Keep packages refrigerated, observe recalls, avoid cross-contamination, and cook enoki thoroughly rather than serving it raw. Pregnant people, older adults, newborns, and immunocompromised people face higher risk from invasive listeriosis and should follow local public-health advice. Never forage “wild enoki” without expert verification because deadly Galerina can share wood habitat and cool-season timing.
