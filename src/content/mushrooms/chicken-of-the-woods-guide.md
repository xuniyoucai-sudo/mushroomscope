---
title: "Chicken of the Woods: Identification and Lookalikes"
description: "Explore chicken of the woods, including identification features, habitat, season, lookalikes, uses, and essential safety notes."
keywords: ["chicken of the woods identification and lookalikes", "mushrooms guide", "mushroom guide"]
category: mushrooms
...
# Chicken of the Woods: Identification and Lookalikes

> **Draft template:** Replace every bracketed note with original, verified reporting before changing `draft` to `false`.

## Search intent

- **Primary query:** chicken of the woods identification and lookalikes
