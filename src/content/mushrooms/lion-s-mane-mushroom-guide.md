---
title: "Hericium erinaceus: Lion’s Mane Mushroom Species Guide"
description: "Learn lion’s mane identification, hardwood ecology, cultivation, nutrition, supplement evidence, lookalikes, safety limits, and practical FAQs."
keywords: ["Hericium erinaceus","lion's mane","mushroom identification","mushroom growing guide"]
category: mushrooms
...
coverAlt: "Cream-white lion's mane mushroom with cascading spines fruiting from hardwood"
...
taxonomy:
  ...
  genus: Hericium
identification:
  summary: "A mature specimen forms one compact, largely unbranched mass with many pendant spines. Young tissue is white; aging tissue may cream or yellow. The teeth lengthen as the fruit body matures and carry the spore-producing surface. Closely related Hericium species may branch more extensively. Field records should include the host tree, attachment, whole growth form, tooth length, color changes, and a spore print."
  keyFeatures: ["No conventional cap; the fruit body forms a rounded to irregular white mass.","The fertile surface covers numerous hanging, unbranched teeth or spines.","A short hidden base attaches the single compact mass to wood.","White."]
appearance:
  cap: "No conventional cap; the fruit body forms a rounded to irregular white mass."
  hymenium: "The fertile surface covers numerous hanging, unbranched teeth or spines."
  stem: "A short hidden base attaches the single compact mass to wood."
  flesh: "White, solid yet tender when young, yellowing and becoming tougher with age."
  sporePrint: "White."
habitat:
  summary: "A wood-decaying fungus found on wounds, cavities, dead sections, logs, and stumps of hardwood trees."
  regions: ["Europe","Asia","North America, with regional Hericium relatives","cultivated worldwide"]
  substrates: ["hardwood logs","sterilized supplemented hardwood sawdust"]
season:
  summary: "Wild fruiting usually occurs from late summer through autumn, varying with climate; indoor crops are year-round."
  months: ["August","September","October","November"]
edibility:
  status: edible
  notes: "Young cultivated fruit bodies are eaten cooked; verify local conservation rules before any wild collection."
toxicity:
  level: none-known
  notes: "No characteristic food poisoning is recognized for cooked cultivated lion's mane, but allergy and gastrointestinal intolerance can occur; supplement evidence is limited."
nutrition:
  summary: "Provides fiber, protein, minerals, fungal beta-glucans, and ergothioneine, with composition varying by substrate and whether a product contains fruit body or mycelium."
growingDifficulty:
  level: moderate
  notes: "Cultivation is feasible on sterilized hardwood blocks but fruit shape is sensitive to humidity, carbon dioxide, and direct water exposure."
similarSpecies:
  - name: "Hericium americanum"
    differences: "Typically develops a more branched structure with teeth on branches; geography and microscopic evidence matter."
  - name: "Hericium coralloides"
    differences: "Usually coral-like and repeatedly branched rather than one compact pom-pom."
  - name: "Other tooth fungi"
